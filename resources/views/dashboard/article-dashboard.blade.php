...
<body>
    <x-layout>
        ...
        <div class="container mt-5 full-height">
            ...
            <a href="{{ route('dashboard.article.create') }}" class="btn btn-primary">Create Article</a>
            @if(session('success'))
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center action-column ">
                                    ...
                                    <form action="{{ route('dashboard.article.destroy',$article->id) }}" method="post" class="d-inline">
                                        @method('delete')
                                        @csrf
